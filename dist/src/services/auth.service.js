...
var token_utils_1 = __importDefault(require("../utils/token.utils"));
var createUser = function (input) { return __awaiter(void 0, void 0, void 0, function () {
    var email, username, password, hashedPassword, user;
...
var login = function (input) { return __awaiter(void 0, void 0, void 0, function () {
...
exports.login = login;
var getCurrentUser = function (username) { return __awaiter(void 0, void 0, void 0, function () {
    var user;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, prisma_client_1.default.user.findUnique({
                    where: {
                        username: username
                    },
                    select: {
